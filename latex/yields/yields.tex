...
\begin{figure*}
\centering 
\includegraphics[scale = 0.3]{\main/yields/n_agb_yields.pdf} 
\caption{
...
% All models show the metallicity-dependent nature of seconday nitrogen 
% production, whose fractional yields increase with progenitor mass at fixed 
% metallicity. 
...
% and for this reason, to first order the net effect of the CNO cycle is to turn 
% all of the C and O into~$^{14}$N at their expense. 
% \par 
% By comparing the three panels of Fig.~\ref{fig:n_agb_yields}, it's clear that 
% the~\citet{Karakas2010} yields predict the secondary nitrogen production in 
% high mass stars to be a much stronger effect than both~\citet{Cristallo2011} 
% and~\citet{Ventura2013}. 
% The mass-dependence is also the most complicated in~\citet{Karakas2010}. 
% Intuitively, one would expect the secondary N yields to increase monotonically 
% with metallicity as the higher abundances of C and O provide more seed nuclei 
% to make~$^{14}$N via the CNO cycle. 
% This is not the case in the~\citet{Karakas2010} yields, where the highest 
% yields are actually at low metallicity.  
% By omparing the left and middle panels of Fig.~\ref{fig:n_agb_yields}, 
