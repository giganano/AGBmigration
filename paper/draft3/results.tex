...
models (see discussion in~\S~\ref{sec:results:yields:variations}), but the
...
dependence in equation~\refp{eq:advocated_n_yield} to the AGB component, but
...
Fig.~\ref{fig:no_oh_observed} as opposed to the~\citet{Dopita2016} relation
...
The agreement in Fig.~\ref{fig:vincenzo_comp} would also be improved by a
...
\refp{eq:advocated_n_agb_yield}, we can write
\begin{equation}
