...
\begin{itemize} 
	...
	\begin{itemize}
		...
		Chieffi2004, Chieffi2013, Limongi2006, Nomoto2013}, but recent studies
		contest the validity of this assumption.
		...
		With~\vice's~\texttt{vice.yields.ccsne.fractional} function, designed
		to calculate values of~$y_\text{X}^\text{CC}$ for various elements (see
		discussion in~\S~4 of~\citealp{Griffith2021}), we indeed find a value
		of~$y_\text{O}^\text{CC} = 0.0056$ using the W18 explosion model from
		\citet{Sukhbold2016} compared to our fiducial value
		of~$y_\text{O}^\text{CC} = 0.015$.
	\end{itemize}
