...
\begin{itemize} 
	...
	\begin{itemize}
		...
		relation as observed with the~\cristallo~and~\ventura~AGB star yield
		models, our model requires extensive black hole formation for massive
		stars, an artificial amplification of N yields from AGB stars, or some
		mix of the two.
	\end{itemize}
