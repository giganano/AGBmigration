...
For a~\citet{Kroupa2001} initial mass function (IMF), the solar metallicity
CCSN yields of~\citet{Chieffi2013} and~\citet[][based on
the~\citealp{Sukhbold2016} models with forced explosion]{Griffith2021a}
...
ISM~\citep{Linsky2006}, while substantially lower~$\ycc{O}$ leads to
disagreement~\citep{Weinberg2017b}.
\par
