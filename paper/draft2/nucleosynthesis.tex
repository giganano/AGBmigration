...
reactions in HBB.
% and the base of the convective envelope is hotter, increasing the rate
...
% % \begin{tabularx}{\textwidth}{l @{\extracolsep{\fill}}l l l r}
% \hline
% Linear & \cristallo & \ventura & \karakasten & \karakas
% \\
% \hline
% equation~\refp{eq:linear_yield} &
% \citet{Cristallo2011, Cristallo2015} &
% \citet{Ventura2013, Ventura2014, Ventura2018, Ventura2020} &
% \citet{Karakas2010} &
% \citet{Karakas2016, Karakas2018}
% \\
% \ref{sec:results}.* &
...
% \\
% \hline
% \cristallo & \ref{sec:results:yields},~\ref{sec:results:yields:variations}
% \\
% \citet{Cristallo2011, Cristallo2015} & \null
% \\
% \hline
% \ventura & \ref{sec:results:yields},~\ref{sec:results:yields:variations}
% \\
% \citet{Ventura2013, Ventura2014, Ventura2018, Ventura2020} & \null
% \\
% \hline
% \karakasten & \ref{sec:results:yields},~\ref{sec:results:yields:yncc}
% \\
% \citet{Karakas2010} & \null
% \\
% \hline
% \karakas & \ref{sec:results:yields},~\ref{sec:results:yields:yncc}
% \\
% \citet{Karakas2016, Karakas2018} & \null
% \\
% \hline
...
% \begin{table}
% \caption{
% A summary of our AGB star yield models and in which sections we present tests
% of each model.
% We take a fiducial value of~$\ycc{N} = 3.6\times10^{-4}$ for our IMF-averaged
% massive star yield (see discussion in~\S~\ref{sec:yields:ccsne}), and we
% explore alternate parametrizations of this value
...
% \\
% \hline
% Linear (equation~\ref{eq:linear_yield}) &
% % \ref{sec:results}.*
% \ref{sec:results:fiducial},~\ref{sec:results:yields:variations},
% \ref{sec:results:t_z_dep_comp},~\ref{sec:results:vincenzo_comp},
% \ref{sec:results:schaefer_comp}
