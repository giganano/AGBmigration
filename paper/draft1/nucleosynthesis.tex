...
\begin{itemize}
	...
	% the~\cristallo~model.
	% This is the default set of AGB star yields in~\vice.
...
hydrogen-depleted core, mixing some of this material into the envelope itself.
...
slightly hotter and more compact, giving them hotter HBB and deeper TDU.
...
mass-loss rate relative to~\karakasten, truncating the N yield.
...
The characteristic timescales for N production are shorter in our alternate
