...
\begin{itemize} 
	...
	\begin{itemize} 
		...
		\begin{itemize} 
			...
			that can explain the observed N abundances without any modification. 
			The~\karakasten~yields, however, without modification overpredict 
			the N abundances at low metallicity. 
			...
			TDU and HBB (see discussion in~\S~\ref{sec:methods:yields:agb}). 
			...
			at low [O/H] with no modification, although such yields may be the 
			result of different physics than the TDU-HBB interplay. 
		\end{itemize} 
